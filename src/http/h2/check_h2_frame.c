...
{
  h2_frame_data_t * frame = (h2_frame_data_t *) h2_frame_init(FRAME_TYPE_DATA, FLAG_END_STREAM, 1);
...
START_TEST(test_h2_frame_emit_data_twice)
{
  ...
  h2_frame_data_t * frame = (h2_frame_data_t *) h2_frame_init(FRAME_TYPE_DATA, 0, 1);
  frame->payload = d1;
  frame->payload_length = DEFAULT_MAX_FRAME_SIZE;
  ck_assert_uint_eq(frame->type, FRAME_TYPE_DATA);
  ...
  h2_frame_data_t * frame2 = (h2_frame_data_t *) h2_frame_init(FRAME_TYPE_DATA, FLAG_END_STREAM, 1);
...
START_TEST(test_h2_frame_emit_data_with_padding)
{
  h2_frame_data_t * frame = (h2_frame_data_t *) h2_frame_init(FRAME_TYPE_DATA, FLAG_END_STREAM | FLAG_PADDED, 1);
  ck_assert_uint_eq(frame->type, FRAME_TYPE_DATA);
  ck_assert_uint_eq(frame->flags, FLAG_END_STREAM | FLAG_PADDED);
  ck_assert_uint_eq(frame->length, 0);

  frame->padding_length = 5;
  uint8_t d[] = {
    0xde, 0xad, 0xbe, 0xef
  };
  frame->payload = d;
  ...
  ck_assert_uint_eq(binary_buffer_size(&bb), 19);
  ck_assert_uint_eq(OUT(0), 0);
  ck_assert_uint_eq(OUT(1), 0);
  ck_assert_uint_eq(OUT(2), 10);
  ck_assert_uint_eq(OUT(3), FRAME_TYPE_DATA);
  ck_assert_uint_eq(OUT(4), FLAG_END_STREAM | FLAG_PADDED);
  ck_assert_uint_eq(OUT(5), 0);
  ck_assert_uint_eq(OUT(6), 0);
  ck_assert_uint_eq(OUT(7), 0);
  ck_assert_uint_eq(OUT(8), 1);
  ck_assert_uint_eq(OUT(9), 5);
  ck_assert_uint_eq(OUT(10), 0xde);
  ck_assert_uint_eq(OUT(11), 0xad);
  ck_assert_uint_eq(OUT(12), 0xbe);
  ck_assert_uint_eq(OUT(13), 0xef);
...
{
  h2_frame_headers_t * frame = (h2_frame_headers_t *) h2_frame_init(FRAME_TYPE_HEADERS, FLAG_END_HEADERS, 1);
  ck_assert_uint_eq(frame->stream_id, 1);
...
{
  h2_frame_headers_t * frame = (h2_frame_headers_t *) h2_frame_init(FRAME_TYPE_HEADERS, FLAG_END_STREAM | FLAG_END_HEADERS, 1);
  ck_assert_uint_eq(frame->stream_id, 1);
  ck_assert_uint_eq(frame->type, FRAME_TYPE_HEADERS);
...
START_TEST(test_h2_frame_emit_headers_with_padding)
{
  h2_frame_headers_t * frame = (h2_frame_headers_t *) h2_frame_init(FRAME_TYPE_HEADERS,
      FLAG_END_HEADERS | FLAG_PADDED, 1);
  ck_assert_uint_eq(frame->stream_id, 1);
  ck_assert_uint_eq(frame->type, FRAME_TYPE_HEADERS);
  ck_assert_uint_eq(frame->flags, FLAG_END_HEADERS | FLAG_PADDED);
  ck_assert_uint_eq(frame->length, 0);
  ...
  ck_assert_uint_eq(OUT(2), 10);
  ck_assert_uint_eq(OUT(3), FRAME_TYPE_HEADERS);
  ck_assert_uint_eq(OUT(4), FLAG_END_HEADERS | FLAG_PADDED);
  ck_assert_uint_eq(OUT(5), 0);
  ck_assert_uint_eq(OUT(6), 0);
  ck_assert_uint_eq(OUT(7), 0);
  ck_assert_uint_eq(OUT(8), 1);
...
{
  h2_frame_rst_stream_t * frame = (h2_frame_rst_stream_t *) h2_frame_init(FRAME_TYPE_RST_STREAM, 0, 1);
  ck_assert_uint_eq(frame->stream_id, 1);
...
{
  h2_frame_settings_t * frame = (h2_frame_settings_t *) h2_frame_init(FRAME_TYPE_SETTINGS, 0, 0);
  ck_assert_uint_eq(frame->stream_id, 0);
...
{
  h2_frame_settings_t * frame = (h2_frame_settings_t *) h2_frame_init(FRAME_TYPE_SETTINGS, FLAG_ACK, 0);
  ck_assert_uint_eq(frame->stream_id, 0);
  ck_assert_uint_eq(frame->type, FRAME_TYPE_SETTINGS);
  ck_assert_uint_eq(frame->flags, FLAG_ACK);
  ck_assert_uint_eq(frame->length, 0);
...
{
  h2_frame_push_promise_t * frame = (h2_frame_push_promise_t *) h2_frame_init(FRAME_TYPE_PUSH_PROMISE, FLAG_END_HEADERS, 1);
  ck_assert_uint_eq(frame->stream_id, 1);
...
{
  h2_frame_push_promise_t * frame = (h2_frame_push_promise_t *) h2_frame_init(FRAME_TYPE_PUSH_PROMISE, FLAG_END_STREAM | FLAG_END_HEADERS, 1);
  ck_assert_uint_eq(frame->stream_id, 1);
  ck_assert_uint_eq(frame->type, FRAME_TYPE_PUSH_PROMISE);
  ck_assert_uint_eq(frame->flags, FLAG_END_HEADERS | FLAG_END_STREAM);
  ck_assert_uint_eq(frame->length, 0);
...
{
  h2_frame_goaway_t * frame = (h2_frame_goaway_t *) h2_frame_init(FRAME_TYPE_GOAWAY, 0, 0);
  ck_assert_uint_eq(frame->stream_id, 0);
...
{
  h2_frame_window_update_t * frame = (h2_frame_window_update_t *) h2_frame_init(FRAME_TYPE_WINDOW_UPDATE, 0, 0);
  ck_assert_uint_eq(frame->stream_id, 0);
...
{
  h2_frame_window_update_t * frame = (h2_frame_window_update_t *) h2_frame_init(FRAME_TYPE_WINDOW_UPDATE, 0, 1);
  ck_assert_uint_eq(frame->stream_id, 1);
  ck_assert_uint_eq(frame->type, FRAME_TYPE_WINDOW_UPDATE);
  ck_assert_uint_eq(frame->flags, 0);
  ck_assert_uint_eq(frame->length, 0);
...
{
  h2_frame_continuation_t * frame = (h2_frame_continuation_t *) h2_frame_init(FRAME_TYPE_CONTINUATION, FLAG_END_HEADERS, 1);
  ck_assert_uint_eq(frame->stream_id, 1);
...
Suite * hpack_suite()
{
  ...
  tcase_add_test(tc, test_h2_frame_emit_data_with_padding);
  ...
  tcase_add_test(tc, test_h2_frame_emit_headers_with_padding);
